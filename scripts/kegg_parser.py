#Usage: python3 kegg_parser.py -i path/to/kofamscan/output -l KO_list -k kegg_control.txt
...
clean_sample_KO_matrix_df = sample_KO_matrix_df.replace("_kegg_output_reliable_tabbed_final","",regex=True)
